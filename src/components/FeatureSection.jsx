    ...
    return (
        <div className="relative mt-20 border-b border-neutral-800 min-h-[800px]">
            <div className="text-center">
                ...
                <h2 className="text-3xl sm:texl-5xl lg:text-6xl mt-10 lg:mt-20 tracking-wide">Easily build <span className="bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text">{" "}your code </span></h2>
            </div>
                ...
                {features.map((feature, index) => (
                    <div className="w-full sm:1/2 lg:w-1/3">
                        <div className="flex">
                            ...
                            <div>
                                <h5 className="mt-1 mb-6 text-xl" key={index}>{feature.text}</h5>
